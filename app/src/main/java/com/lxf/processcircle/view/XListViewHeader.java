...
public class XListViewHeader extends LinearLayout {
	...
	public void setHintTextView(String result, boolean flag) {
		...
		mArrowImageView.setVisibility(View.VISIBLE);
		if(flag) {
			mArrowImageView.setImageResource(R.mipmap.sport_refresh_success);
		} else {
			mArrowImageView.setImageResource(R.mipmap.sport_refresh_warnning);
		}
	...
	public void resetHintTextView() {
		mProgressBar.setVisibility(View.GONE);
		mArrowImageView.setVisibility(View.VISIBLE);
		mArrowImageView.setImageResource(R.mipmap.sport_pulldown);
	}
